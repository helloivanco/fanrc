          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-3 sm:gap-4'>
              <a
                ...
                aria-label='Open Fan RC Facebook page in a new tab'
                tabIndex={0}
                className='inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#1877F2] text-white shadow-sm transition-transform duration-200 hover:scale-105 hover:bg-[#166FE5] focus:outline-none focus:ring-2 focus:ring-[#1877F2] focus:ring-offset-2'
                onKeyDown={(event) => {
